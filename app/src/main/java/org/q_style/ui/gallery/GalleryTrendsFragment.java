...
public class GalleryTrendsFragment extends Fragment implements ExoPlayer.EventListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_gallery_trends, container, false);

        // массивы данных
        String[] texts1 = {"For Bigger Joyrides", "For Bigger Meltdowns", "Sintel", "Big Buck Bunny", "Elephant Dream", "For Bigger Blazes",
                "For Bigger Escape", "For Bigger Fun'"};
        String[] texts2 = {"Introducing Chromecast. The easiest way to enjoy online video and music on your TV—for the times that call for bigger joyrides.",
        ...
        int[] img = new int[]{R.drawable.joyfriends, R.drawable.meltdowns, R.drawable.sintel, R.drawable.bigbuckbunny, R.drawable.elephantdream, R.drawable.biggerblazeazes,
                R.drawable.biggerbigger, R.drawable.joyfriends};
        ...
        // создаем адаптер
        SimpleAdapter sAdapter = new SimpleAdapter(getActivity(), data, R.layout.item_video_trends,
                from, to);
